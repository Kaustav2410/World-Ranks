...
export const SearchBar = ({length}) => {
  ...
  return (
    <div className='SearchBar flex text-white justify-between items-center font-Vietnam_Pro py-6 gap-'>
        <div> 
            <p>Found {length} countries</p>
        </div>
        <div className='rounded-xl pr-7 pl-3  py-[.5rem] bg-light-black text-xs flex gap-3 w-2/5 max-lg:w-8/12'>
